...
function Easy() {
    ...
    return (
      <span key={i}>
        <img
          key={item.id}
          style={{
            borderColor: selectedList === i ? item.color : "transparent",
            borderWidth: 3,
          }}
  ...
  return (
    <div className="App easyAp text-center ">
      ...
      <p className="mb-2"></p>
      <h1
        className={toggle ? "head-color" : "head-toggle"}
      ...
      <div className="format d-block mt-5">
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <button
            className="btn-primary infbutton"
      ...
      <main className="d-block mb-5">
        ...
        <br />
        <br />
        <button className="btn px-5 " onClick={() => setHowTimes(howInput)}>
          Wallet {submittedTimes}
        </button>
        <br />
        <br />
        <button
